package com.dlt.server.common.util.encry;
...
public class MD5EncryptUtil {
    ...
    private static final String saltAdded = "8eabe16689abea685bea30a252dfa519";
    /**
     * 加密次数，默认为2
     */
    private static int hashIterations = 2;
    private static int hashIterationsForTextEncrypt = 1;
    /**
     * 盐是否不可用
     */
    ...
    public static String encryptPassword(String password, String salt) throws IllegalArgumentException {
        ...
        return new Md5Hash(password, salt + saltAdded, hashIterations).toHex();
    }
     ...
     */
    public static String encryptPassword(String text) throws IllegalArgumentException {
        return new Md5Hash(text, null, hashIterationsForTextEncrypt).toHex();
    }
    ...
    public static byte[] getSHA1Digest(String data) throws IOException {
        ...
        try {
            ...
            bytes = md.digest(data.getBytes(ConstCommonString.STRING_ENCODING_UTF8));
